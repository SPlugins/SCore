...
public enum FeatureSettingsSCoreFR implements FeatureSettingsInterface {
    ...
    baseDamageBlocked("baseDamageBlocked", "Dégâts de Base Bloqués", new String[]{"&7&oLes dégâts de base bloqués"}, GUI.CLOCK),
    blockAttacksFeatures("blockAttacksFeatures", "Fonctionnalités de Blocage d'Attaques", new String[]{"&7&oLes fonctionnalités de blocage d'attaques"}, FixedMaterial.getMaterial(Arrays.asList("SHIELD"))),
    blockDelay("blockDelay", "Délai de Blocage", new String[]{"&7&oLe délai de blocage en secondes"}, GUI.CLOCK),
    blockSound("blockSound", "Son de Blocage", new String[]{"&7&oSon quand une attaque est bloquée"}, Material.NOTE_BLOCK),
    ...
    bypassedBy("bypassedBy", "Contourné Par", new String[]{"&7&oContourné par"}, Material.ANVIL),
    ...
    cancelSpawner("cancel-spawner", "Annuler Spawner", new String[]{"&7&oL'objet ne peut pas être", "&7&outilisé sur un spawner"}, FixedMaterial.getMaterial(Collections.singletonList("SPAWNER"))),
    ...
    damageReduction("damageReduction", "Réduction de Dégâts", new String[]{"&7&oLa réduction de dégâts"}, Material.ANVIL),
    damageReductions("damageReductions", "Réductions de Dégâts", new String[]{"&7&oLes réductions de dégâts"}, Material.ANVIL),
    damageTypes("damageTypes", "Types de Dégâts", new String[]{"&7&oLes types de dégâts"}, Material.ANVIL),
    ...
    detailedInput("detailedInput", "Entrée Détaillée", new String[]{"&7&oL'entrée spécifique"}, Material.COMPASS),
    ...
    detailedTargetItems("detailedTargetItems", "Items Cibles Détaillés", new String[]{"&7&oFaire fonctionner l'activateur", "&7&ouniquement pour certains items", "&7&ovide = tous les items"}, FixedMaterial.getMaterial(Arrays.asList("TORCH"))),
    disableCooldownScale("disableCooldownScale", "Désactiver l'Échelle de Cooldown", new String[]{"&7&oDésactiver l'échelle de cooldown"}, null),
    disableSound("disableSound", "Son de Désactivation", new String[]{"&7&oSon quand le blocage est désactivé"}, Material.NOTE_BLOCK),
    ...
    dropFeatures("dropFeatures", "Options de Drop", new String[]{"&7&oLes fonctionnalités de drop"}, Material.DROPPER),
    ...
    factorDamageBlocked("factorDamageBlocked", "Facteur de Dégâts Bloqués", new String[]{"&7&oLe facteur de dégâts bloqués", "&7De 0 à 1"}, GUI.CLOCK),
    ...
    horizontalBlockingAngle("horizontalBlockingAngle", "Angle de Blocage Horizontal", new String[]{"&7&oL'angle de blocage horizontal"}, GUI.CLOCK),
    ...
    ifEntityAge("ifEntityAge", "Si âge de l'entité", new String[]{}, Material.ANVIL),
    ifEntityHealth("ifEntityHealth", "Si santé de l'entité", new String[]{}, Material.ANVIL),
    ifEntityInRegion("ifEntityInRegion", "Si l'entité est dans la région", new String[]{}, Material.ANVIL),
    ifEntityIsInLava("ifEntityIsInLava", "Si l'entité est dans la lave", new String[]{}, Material.ANVIL),
    ifEntityIsInWater("ifEntityIsInWater", "Si l'entité est dans l'eau", new String[]{}, Material.ANVIL),
    ifEntityLastDamageCause("ifEntityLastDamageCause", "Si dernière cause de dégâts de l'entité", new String[]{}, Material.ANVIL),
    ifEntityVelocity("ifEntityVelocity", "Si vélocité de l'entité", new String[]{}, Material.ANVIL),
    ...
    ifGameMode("ifGameMode", "Si Mode de Jeu", new String[]{"&7&oSi le mode de jeu est"}, Material.ANVIL),
    ...
    ifLineOfSight("ifLineOfSight", "Si ligne de vue", new String[]{"&7Si le joueur a une ligne de vue vers une entité vivante"}, null),
    ...
    ifNearbyEntityCount("ifNearbyEntityCount", "Si nombre d'entités proches", new String[]{"&7Comparer le nombre d'entités proches"}, Material.ANVIL),
    ifNearbyPlayerCount("ifNearbyPlayerCount", "Si nombre de joueurs proches", new String[]{"&7Comparer le nombre de joueurs proches"}, Material.ANVIL),
    ...
    ifNotEntityInRegion("ifNotEntityInRegion", "Si l'entité n'est pas dans la région", new String[]{}, Material.ANVIL),
    ...
    ifPlayerBedSpawnLocationX("ifPlayerBedSpawnLocationX", "Si position X du lit du joueur", new String[]{}, Material.ANVIL),
    ifPlayerBedSpawnLocationY("ifPlayerBedSpawnLocationY", "Si position Y du lit du joueur", new String[]{}, Material.ANVIL),
    ifPlayerBedSpawnLocationZ("ifPlayerBedSpawnLocationZ", "Si position Z du lit du joueur", new String[]{}, Material.ANVIL),
    ...
    ifPlayerIsRiding("ifPlayerIsRiding", "Si le joueur chevauche", new String[]{}, Material.ANVIL),
    ifPlayerLastDamage("ifPlayerLastDamage", "Si derniers dégâts du joueur", new String[]{}, Material.ANVIL),
    ...
    ifPlayerOxygen("ifPlayerOxygen", "Si oxygène du joueur", new String[]{}, Material.ANVIL),
    ...
    ifPlayerSpeed("ifPlayerSpeed", "Si vitesse du joueur", new String[]{"&7Comparer la magnitude de la vélocité du joueur"}, Material.ANVIL),
    ...
    ifSheepColor("ifSheepColor", "Si couleur du mouton", new String[]{}, Material.ANVIL),
    ...
    parsePlaceholders("parsePlaceholders", "Parser les Placeholders", new String[]{"&7&oSi activé, les placeholders comme", "&7&o%player_name% dans les valeurs", "&7&ode la variable seront parsés à la lecture"}, null),
    ...
    placeholderCondition("placeholderCondition", "Condition Placeholder", new String[]{"&7&oUne condition Placeholder avec ses Features"}, GUI.WRITABLE_BOOK),
    ...
    potionEffect("potionEffect", "Effet de Potion", new String[]{"&7&oUn effet de potion avec ses Features"}, FixedMaterial.getBrewingStand()),
    ...
    subPattern("subPattern", "Sous-Motif", new String[]{"&7&oUn sous-motif avec ses Features"}, Material.ANVIL),
    subPatterns("subPatterns", "Sous-Motifs", new String[]{"&7&oLes sous-motifs"}, Material.ANVIL),
    suspiciousBlockLoot("suspiciousBlockLoot", "Butin de Bloc Suspect", new String[]{"&7Le butin que l'ExecutableBlock aura", "&7quand brossé.", "&cREQUIS PAR PLAYER_BRUSH_BLOCK"}, FixedMaterial.getMaterial(Arrays.asList("BRUSH"))),
    ...
    titleAdjustment("titleAdjustment", "Ajustement du Titre", new String[]{"&7&oAjustement du titre"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleFeatures("titleFeatures", "Features du Titre", new String[]{"&7&oLes fonctionnalités du titre"}, Material.ANVIL),
    ...
    variable("variable", "Variable", new String[]{"&7&oUne variable avec ses Features"}, GUI.WRITABLE_BOOK),
    ...
    variableUpdate("variableUpdate", "Mise à jour Variable", new String[]{"&7&oUne mise à jour de variable avec ses Features"}, GUI.WRITABLE_BOOK),
    ...
    canBeSheared("canBeSheared", "Peut Être Tondu", new String[]{"&7&oSi l'item peut être retiré avec des", "&7&ocisailles de l'entité qui le porte"}, FixedMaterial.getMaterial(Arrays.asList("SHEARS"))),
    enableShearingSound("enableShearingSound", "Activer le Son de Tonte", new String[]{"&7&oActive le son joué lors de la tonte"}, null),
    shearingSound("shearingSound", "Son de Tonte", new String[]{"&7&oLe son joué quand l'item est tondu"}, FixedMaterial.getMaterial(Arrays.asList("SHEARS"))),
    equipOnInteract("equipOnInteract", "Équiper au Clic", new String[]{"&7&oÉquipe l'item sur l'entité via un", "&7&oclic droit (comme une selle)"}, null),
    ...
    enable("enable", "Activer", new String[]{"&7&oActiver cette fonctionnalité"}, Material.LEVER),
    ...
    cooldownFeatures("cooldownFeatures", "Features de Cooldown", new String[]{"&7&oLe cooldown"}, GUI.CLOCK),
    globalCooldownFeatures("globalCooldownFeatures", "Features de Cooldown Global", new String[]{"&7&oLe cooldown global", "&7&o(Pour &eTOUS &7&oles joueurs et entités)"}, GUI.CLOCK),
    ...
    playerCooldownFeatures("playerCooldownFeatures", "Features de Cooldown Joueur", new String[]{"&7&oLe cooldown joueur"}, GUI.CLOCK),
    entityCooldownFeatures("entityCooldownFeatures", "Features de Cooldown Entité", new String[]{"&7&oLe cooldown entité"}, GUI.CLOCK),
    ...
    foodFeatures("foodFeatures", "Fonctionnalités de Nourriture", new String[]{"&7&oFonctionnalités de nourriture"}, Material.COOKED_BEEF),
    ...
    itemTextures("itemTextures", "Textures d'Item", new String[]{"&7&oLes textures de l'item"}, FixedMaterial.getMaterial(Arrays.asList("BLUE_GLAZED_TERRACOTTA"))),
    ...
    playerCanSit("playerCanSit", "Le joueur peut s'asseoir", new String[]{"&7&oLe joueur peut s'asseoir"}, FixedMaterial.getMaterial(Arrays.asList("STONE_STAIRS"))),
    ...
    attackRangeFeatures("attackRangeFeatures", "Portée d'Attaque", new String[]{"&7&oLa portée d'attaque de l'arme (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    minReach("minReach", "Portée Min", new String[]{"&7&oLa portée d'attaque minimale en blocs"}, GUI.CLOCK),
    maxReach("maxReach", "Portée Max", new String[]{"&7&oLa portée d'attaque maximale en blocs"}, GUI.CLOCK),
    minCreativeReach("minCreativeReach", "Portée Min Créatif", new String[]{"&7&oLa portée d'attaque minimale en créatif"}, GUI.CLOCK),
    maxCreativeReach("maxCreativeReach", "Portée Max Créatif", new String[]{"&7&oLa portée d'attaque maximale en créatif"}, GUI.CLOCK),
    hitboxMargin("hitboxMargin", "Marge de Hitbox", new String[]{"&7&oMarge ajoutée autour de la hitbox de la cible"}, GUI.CLOCK),
    mobFactor("mobFactor", "Facteur Mob", new String[]{"&7&oMultiplicateur de portée quand le porteur est un mob"}, GUI.CLOCK),
    piercingWeaponFeatures("piercingWeaponFeatures", "Arme Perçante", new String[]{"&7&oL'arme transperce les entités (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    dealsKnockback("dealsKnockback", "Inflige du Recul", new String[]{"&7&oSi l'attaque perçante inflige du recul"}, null),
    dismounts("dismounts", "Démonte", new String[]{"&7&oSi l'attaque démonte les entités touchées"}, null),
    enableHitSound("enableHitSound", "Activer le Son d'Impact", new String[]{"&7&oActive le son joué quand une entité est touchée"}, null),
    kineticWeaponFeatures("kineticWeaponFeatures", "Arme Cinétique", new String[]{"&7&oAttaque en charge/fente selon la vitesse (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    contactCooldownTicks("contactCooldownTicks", "Cooldown de Contact (ticks)", new String[]{"&7&oCooldown en ticks entre deux contacts"}, GUI.CLOCK),
    delayTicks("delayTicks", "Délai (ticks)", new String[]{"&7&oDélai en ticks avant le début de l'effet cinétique"}, GUI.CLOCK),
    forwardMovement("forwardMovement", "Mouvement Avant", new String[]{"&7&oMouvement vers l'avant appliqué pendant la fente"}, GUI.CLOCK),
    damageMultiplier("damageMultiplier", "Multiplicateur de Dégâts", new String[]{"&7&oMultiplicateur de dégâts sur un impact cinétique"}, GUI.CLOCK),
    dismountMaxDurationTicks("dismountMaxDurationTicks", "Démontage - Durée Max (ticks)", new String[]{"&7&oDurée max (ticks) où la condition de démontage reste active"}, GUI.CLOCK),
    dismountMinSpeed("dismountMinSpeed", "Démontage - Vitesse Min", new String[]{"&7&oVitesse minimale requise pour démonter"}, GUI.CLOCK),
    dismountMinRelativeSpeed("dismountMinRelativeSpeed", "Démontage - Vitesse Relative Min", new String[]{"&7&oVitesse relative minimale requise pour démonter"}, GUI.CLOCK),
    knockbackMaxDurationTicks("knockbackMaxDurationTicks", "Recul - Durée Max (ticks)", new String[]{"&7&oDurée max (ticks) où la condition de recul reste active"}, GUI.CLOCK),
    knockbackMinSpeed("knockbackMinSpeed", "Recul - Vitesse Min", new String[]{"&7&oVitesse minimale requise pour le recul"}, GUI.CLOCK),
    knockbackMinRelativeSpeed("knockbackMinRelativeSpeed", "Recul - Vitesse Relative Min", new String[]{"&7&oVitesse relative minimale requise pour le recul"}, GUI.CLOCK),
    damageMaxDurationTicks("damageMaxDurationTicks", "Dégâts - Durée Max (ticks)", new String[]{"&7&oDurée max (ticks) où la condition de dégâts reste active"}, GUI.CLOCK),
    damageMinSpeed("damageMinSpeed", "Dégâts - Vitesse Min", new String[]{"&7&oVitesse minimale requise pour les dégâts cinétiques"}, GUI.CLOCK),
    damageMinRelativeSpeed("damageMinRelativeSpeed", "Dégâts - Vitesse Relative Min", new String[]{"&7&oVitesse relative minimale requise pour les dégâts cinétiques"}, GUI.CLOCK),
    ...
    input3("input3", "Entrée 3", new String[]{}, Material.GLASS),
    input4("input4", "Entrée 4", new String[]{}, Material.GLASS),
    input5("input5", "Entrée 5", new String[]{}, Material.GLASS),
    input6("input6", "Entrée 6", new String[]{}, Material.GLASS),
    input7("input7", "Entrée 7", new String[]{}, Material.GLASS),
    input8("input8", "Entrée 8", new String[]{}, Material.GLASS),
    input9("input9", "Entrée 9", new String[]{}, Material.GLASS),
    input1ItemCheckers("input1ItemCheckers", "Vérificateurs d'Item Entrée 1", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input2ItemCheckers("input2ItemCheckers", "Vérificateurs d'Item Entrée 2", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input3ItemCheckers("input3ItemCheckers", "Vérificateurs d'Item Entrée 3", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input4ItemCheckers("input4ItemCheckers", "Vérificateurs d'Item Entrée 4", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input5ItemCheckers("input5ItemCheckers", "Vérificateurs d'Item Entrée 5", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input6ItemCheckers("input6ItemCheckers", "Vérificateurs d'Item Entrée 6", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input7ItemCheckers("input7ItemCheckers", "Vérificateurs d'Item Entrée 7", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input8ItemCheckers("input8ItemCheckers", "Vérificateurs d'Item Entrée 8", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    input9ItemCheckers("input9ItemCheckers", "Vérificateurs d'Item Entrée 9", new String[]{"&7&oLes vérificateurs d'item"}, Material.ANVIL),
    itemCheckerType("itemCheckerType", "Type de vérification d'objet", new String[]{"&7&oLe type de vérification de l'objet"}, Material.ANVIL),
    itemCheckers("itemCheckers", "Vérificateurs d'objet", new String[]{"&7&oLes vérificateurs d'objet"}, Material.ANVIL),
    sitFeatures("sitFeatures", "Fonctionnalités d'assise", new String[]{"&7&oLes fonctionnalités liées à l'assise"}, FixedMaterial.getMaterial(Arrays.asList("STONE_STAIRS"))),
    storageFeatures("storageFeatures", "Fonctionnalités de stockage", new String[]{"&7&oLes fonctionnalités de stockage"}, FixedMaterial.getMaterial(Arrays.asList("CHEST"))),
    usageFeatures("usageFeatures", "Fonctionnalités d'utilisation", new String[]{"&7&oLes fonctionnalités d'utilisation", "&aAugmentez &7&ou &cDiminuez &7&oce paramètre avec", "&eUsageModification &7&odans vos activateurs"}, Material.BUCKET),
    myFurnitureFeatures("myFurnitureFeatures", "Fonctionnalités MyFurniture", new String[]{"&7&oLes fonctionnalités de MyFurniture"}, FixedMaterial.getMaterial(Arrays.asList("BOOKSHELF"))),
    checkAmount("checkAmount", "Vérifier la quantité", new String[]{"&7&oVérifie la quantité"}, null),
    checkDisplayName("checkDisplayName", "Vérifier le nom affiché", new String[]{"&7&oVérifie le nom affiché"}, null),
    checkMaterial("checkMaterial", "Vérifier le matériau", new String[]{"&7&oVérifie le matériau"}, null),
    checkCustomModelData("checkCustomModelData", "Vérifier les données du modèle", new String[]{"&7&oVérifie les données personnalisées du modèle"}, null),
    checkLore("checkLore", "Vérifier la légende", new String[]{"&7&oVérifie la légende"}, null),
    checkDurability("checkDurability", "Vérifier la durabilité", new String[]{"&7&oVérifie la durabilité"}, null),
    checkExecutableItemID("checkExecutableItemID", "Vérifier l'ID de l'objet Exécutable", new String[]{"&7&oVérifie l'ID de l'objet Executable"}, null),
    checkExecutableItemUsage("checkExecutableItemUsage", "Vérifier l'utilisation de l'objet Exécutable", new String[]{"&7&oVérifie l'utilisation de l'objet Executable"}, null),
    checkExecutableItemVariables("checkExecutableItemVariables", "Vérifier les variables de l'objet Exécutable", new String[]{"&7&oVérifie les variables de l'objet Executable"}, null),
    anvilMergeType("anvilMergeType", "Type de fusion à l'enclume", new String[]{"&7&oLe type de fusion à l'enclume"}, Material.ANVIL),
    itemAdvancedComponents("itemAdvancedComponents", "Composants Avancés d'Item", new String[]{"&7&oLes composants avancés de l'item"}, Material.ARMOR_STAND),
    itemCommands("itemCommands", "Commandes de l'objet", new String[]{"&7&oLes commandes à exécuter pour l'objet"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    playerSettings("playerSettings", "Paramètres du joueur", new String[]{"&7&oLes paramètres du joueur"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    targetItemCommands("targetItemCommands", "Commandes de l'objet cible", new String[]{"&7&oLes commandes à exécuter sur l'objet cible"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    maxFurnitureRendered("maxFurnitureRendered", "Meubles affichés max", new String[]{"&7&oNombre maximum de meubles affichés"}, GUI.CLOCK),
    viewDistanceFurniture("viewDistanceFurniture", "Distance de vue des meubles", new String[]{"&7&oDistance de visualisation des meubles"}, GUI.CLOCK),
    maxDistanceBoundingBoxCalculation("maxDistanceBoundingBoxCalculation", "Distance max pour calculer la boîte englobante", new String[]{"&7&oDistance maximale pour le calcul de la boîte englobante", "&7&oGardez une valeur basse (3-5) en cas de baisse de FPS"}, GUI.CLOCK),
    updateEquippable("updateEquippable", "Mettre à jour l'équipement", new String[]{"&7&oMet à jour les fonctionnalités équipables de l'objet"}, null),
    updateTooltipModel("updateTooltipModel", "Mise à Jour du Modèle de Tooltip", new String[]{"&7&oMettre à jour le modèle de tooltip de l'item"}, null),
    RECIPE("RECIPE", "Recette", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    RECIPEGROUP("RECIPEGROUP", "Groupe de recettes", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    spawnerFeatures("spawnerFeatures", "Fonctionnalités du générateur", new String[]{"&7&oLes fonctionnalités du générateur"}, FixedMaterial.getMaterial(Arrays.asList("SPAWNER"))),
    spawnDelay("spawnDelay", "Délai d'apparition", new String[]{"&7&oLe délai d'apparition"}, GUI.CLOCK),
    minSpawnDelay("minSpawnDelay", "Délai d'apparition minimum", new String[]{"&7&oLe délai d'apparition minimum"}, GUI.CLOCK),
    maxSpawnDelay("maxSpawnDelay", "Délai d'apparition maximum", new String[]{"&7&oLe délai d'apparition maximum"}, GUI.CLOCK),
    spawnCount("spawnCount", "Nombre d'apparitions", new String[]{"&7&oLe nombre d'entités à faire apparaître"}, GUI.CLOCK),
    spawnRange("spawnRange", "Portée d'apparition", new String[]{"&7&oLa portée d'apparition"}, GUI.CLOCK),
    requiredPlayerRange("requiredPlayerRange", "Portée requise du joueur", new String[]{"&7&oLa portée minimale du joueur requise"}, GUI.CLOCK),
    maxNearbyEntities("maxNearbyEntities", "Entités proches max", new String[]{"&7&oNombre maximal d'entités proches"}, GUI.CLOCK),
    potentialSpawns("potentialSpawns", "Apparitions potentielles", new String[]{"&7&oLes entités pouvant apparaître"}, Material.ANVIL),
    addSpawnerNbtToItem("addSpawnerNbtToItem", "Ajouter NBT du générateur à l'objet", new String[]{"&7&oAjoute le NBT du générateur à l'objet", "&cUn avertissement Minecraft apparaîtra dans la description"}, null),
    nexoID("nexoID", "Nexo", new String[]{"&7&oL'identifiant du Nexo"}, Material.DIAMOND_BLOCK),
    myfurnitureID("myfurnitureID", "Identifiant MyFurniture", new String[]{"&7&oL'identifiant MyFurniture"}, FixedMaterial.getMaterial(Arrays.asList("BOOKSHELF"))),
    animation("animation", "Animation", new String[]{"&7&oL'animation"}, Material.ANVIL),
    hasConsumeParticles("hasConsumeParticles", "Particules de consommation", new String[]{"&7&oAffiche des particules lors de la consommation"}, Material.ANVIL),
    consumeSeconds("consumeSeconds", "Temps de consommation (s)", new String[]{"&7&oDurée de consommation en secondes"}, GUI.CLOCK),
    consumableFeatures("consumableFeatures", "Fonctionnalités consommables", new String[]{"&7&oLes fonctionnalités des objets consommables"}, FixedMaterial.getMaterial(Arrays.asList("POTION"))),
    viewRange("viewRange", "Portée de vision", new String[]{"&7&oLa portée de vision"}, GUI.CLOCK),
    recipesList("recipesList", "Liste des recettes", new String[]{"&7&oLa liste des recettes"}, Material.ANVIL),
    typeOfCraftingTableRecipe("typeOfCraftingTableRecipe", "Type de recette d'établi", new String[]{"&7&oLe type de recette utilisée sur l'établi"}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    cookingTime("cookingTime", "Temps de cuisson", new String[]{"&7&oLe temps de cuisson"}, GUI.CLOCK),
    experience("experience", "Expérience", new String[]{"&7&oL'expérience gagnée"}, GUI.CLOCK),
    result("result", "Résultat", new String[]{"&7&oLe résultat"}, Material.ANVIL),
    recipeType("recipeType", "Type de recette", new String[]{"&7&oLe type de recette"}, Material.ANVIL),
