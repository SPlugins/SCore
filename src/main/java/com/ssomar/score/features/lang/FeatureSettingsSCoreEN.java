...
public enum FeatureSettingsSCoreEN implements FeatureSettingsInterface {
    ...
    canBeSheared("canBeSheared", "Can Be Sheared", new String[]{"&7&oIf the item can be sheared off the", "&7&oentity wearing it (e.g. with shears)"}, FixedMaterial.getMaterial(Arrays.asList("SHEARS"))),
    enableShearingSound("enableShearingSound", "Enable Shearing Sound", new String[]{"&7&oEnable the sound played when sheared"}, null),
    shearingSound("shearingSound", "Shearing Sound", new String[]{"&7&oThe sound played when the item is sheared"}, FixedMaterial.getMaterial(Arrays.asList("SHEARS"))),
    equipOnInteract("equipOnInteract", "Equip On Interact", new String[]{"&7&oEquip the item on the entity by", "&7&oright-clicking it (e.g. like a saddle)"}, null),
    ...
    attackRangeFeatures("attackRangeFeatures", "Attack Range Features", new String[]{"&7&oThe attack range of the weapon (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    minReach("minReach", "Min Reach", new String[]{"&7&oThe minimum attack reach in blocks"}, GUI.CLOCK),
    maxReach("maxReach", "Max Reach", new String[]{"&7&oThe maximum attack reach in blocks"}, GUI.CLOCK),
    minCreativeReach("minCreativeReach", "Min Creative Reach", new String[]{"&7&oThe minimum attack reach in creative mode"}, GUI.CLOCK),
    maxCreativeReach("maxCreativeReach", "Max Creative Reach", new String[]{"&7&oThe maximum attack reach in creative mode"}, GUI.CLOCK),
    hitboxMargin("hitboxMargin", "Hitbox Margin", new String[]{"&7&oExtra margin added around the target hitbox"}, GUI.CLOCK),
    mobFactor("mobFactor", "Mob Factor", new String[]{"&7&oReach multiplier applied when the holder is a mob"}, GUI.CLOCK),
    piercingWeaponFeatures("piercingWeaponFeatures", "Piercing Weapon Features", new String[]{"&7&oThe weapon pierces through entities (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    dealsKnockback("dealsKnockback", "Deals Knockback", new String[]{"&7&oWhether the piercing attack deals knockback"}, null),
    dismounts("dismounts", "Dismounts", new String[]{"&7&oWhether the attack dismounts hit entities"}, null),
    enableHitSound("enableHitSound", "Enable Hit Sound", new String[]{"&7&oEnable the sound played when an entity is hit"}, null),
    kineticWeaponFeatures("kineticWeaponFeatures", "Kinetic Weapon Features", new String[]{"&7&oCharge/lunge attack based on speed (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    contactCooldownTicks("contactCooldownTicks", "Contact Cooldown Ticks", new String[]{"&7&oCooldown in ticks between two contacts"}, GUI.CLOCK),
    delayTicks("delayTicks", "Delay Ticks", new String[]{"&7&oDelay in ticks before the kinetic effect starts"}, GUI.CLOCK),
    forwardMovement("forwardMovement", "Forward Movement", new String[]{"&7&oForward movement applied during the lunge"}, GUI.CLOCK),
    damageMultiplier("damageMultiplier", "Damage Multiplier", new String[]{"&7&oDamage multiplier applied on a kinetic hit"}, GUI.CLOCK),
    dismountMaxDurationTicks("dismountMaxDurationTicks", "Dismount - Max Duration Ticks", new String[]{"&7&oMax duration (ticks) the dismount condition stays active"}, GUI.CLOCK),
    dismountMinSpeed("dismountMinSpeed", "Dismount - Min Speed", new String[]{"&7&oMinimum speed required to dismount"}, GUI.CLOCK),
    dismountMinRelativeSpeed("dismountMinRelativeSpeed", "Dismount - Min Relative Speed", new String[]{"&7&oMinimum relative speed required to dismount"}, GUI.CLOCK),
    knockbackMaxDurationTicks("knockbackMaxDurationTicks", "Knockback - Max Duration Ticks", new String[]{"&7&oMax duration (ticks) the knockback condition stays active"}, GUI.CLOCK),
    knockbackMinSpeed("knockbackMinSpeed", "Knockback - Min Speed", new String[]{"&7&oMinimum speed required for knockback"}, GUI.CLOCK),
    knockbackMinRelativeSpeed("knockbackMinRelativeSpeed", "Knockback - Min Relative Speed", new String[]{"&7&oMinimum relative speed required for knockback"}, GUI.CLOCK),
    damageMaxDurationTicks("damageMaxDurationTicks", "Damage - Max Duration Ticks", new String[]{"&7&oMax duration (ticks) the damage condition stays active"}, GUI.CLOCK),
    damageMinSpeed("damageMinSpeed", "Damage - Min Speed", new String[]{"&7&oMinimum speed required to apply kinetic damage"}, GUI.CLOCK),
    damageMinRelativeSpeed("damageMinRelativeSpeed", "Damage - Min Relative Speed", new String[]{"&7&oMinimum relative speed required to apply kinetic damage"}, GUI.CLOCK),
    ...
    disabledWorlds("disabledWorlds", "Disabled/Blacklisted worlds", new String[]{"&7&oDisabled/Blacklisted worlds","","&7&oTo whitelist, add \"!\" at the start", "&7&oof the world name"}, FixedMaterial.getMaterial(Arrays.asList("GRASS_BLOCK", "GRASS"))),
    ...
    ifBlockWorld("ifBlockWorld", "If block world", new String[]{}, Material.ANVIL),
    ...
    ifEntityAge("ifEntityAge", "If entity age", new String[]{}, Material.ANVIL),
    ...
    ifPlayerBedSpawnLocationX("ifPlayerBedSpawnLocationX", "If player bed spawn location X", new String[]{}, Material.ANVIL),
    ifPlayerBedSpawnLocationY("ifPlayerBedSpawnLocationY", "If player bed spawn location Y", new String[]{}, Material.ANVIL),
    ifPlayerBedSpawnLocationZ("ifPlayerBedSpawnLocationZ", "If player bed spawn location Z", new String[]{}, Material.ANVIL),
    ...
    ifPlayerIsRiding("ifPlayerIsRiding", "If player is riding", new String[]{}, Material.ANVIL),
    ifPlayerLevel("ifPlayerLevel", "If player level", new String[]{}, Material.ANVIL),
    ifPlayerLastDamage("ifPlayerLastDamage", "If player last damage", new String[]{}, Material.ANVIL),
    ...
    ifPlayerOxygen("ifPlayerOxygen", "If player oxygen", new String[]{}, Material.ANVIL),
    ...
    oraxen("oraxen", "Oraxen", new String[]{"&7&oThe item required to", "&7&oexecute this trade"}, Material.DIAMOND),
    oraxenID("oraxenID", "Oraxen", new String[]{"&7&oThe Oraxen ID"}, Material.DIAMOND_BLOCK),
    nexo("nexo", "Nexo", new String[]{"&7&oThe item required to", "&7&oexecute this trade"}, Material.BRICK_STAIRS),
    ...
    ifEntityIsInWater("ifEntityIsInWater", "If entity is in water", new String[]{}, Material.ANVIL),
