...
public enum FeatureSettingsSCoreEN implements FeatureSettingsInterface {
    ...
    papiParser("papiParser", "PlaceholderAPI Parser", new String[]{"&7The text you want to use along with the", "&7variable value in order for it to work", "&7with PlaceholderAPI placeholders.", "", "&7Check wiki for further details"}, Material.getMaterial("LEAD") != null ? Material.valueOf("LEAD") : Material.valueOf("LEASH"))
    ;
