...
public class AddItemNBT extends ItemCommand {

    public AddItemNBT() {
        CommandSetting keyValue = new CommandSetting("keyValue", 0, String.class, "foo=bar");
        CommandSetting type = new CommandSetting("type", 1, String.class, "string");
        CommandSetting mode = new CommandSetting("mode", 2, String.class, "pdc");
    ...
    public String getTemplate() {
        return "ADD_ITEM_NBT keyValue:foo=bar type:string mode:pdc";
    }
