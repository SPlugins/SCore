...
/**
 * Fired when a flowing liquid is about to break a placed ExecutableBlock.
 * Cancelling the event protects the block (the liquid flow is cancelled).
 */
@Getter
public class ExecutableBlockLiquidBreakEvent extends Event implements Cancellable {
     ...
     */
    public ExecutableBlockLiquidBreakEvent(@NotNull ExecutableBlockPlacedInterface executableBlockPlaced) {
