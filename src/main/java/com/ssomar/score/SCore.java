...
public final class SCore extends JavaPlugin implements SPlugin {
    ...
    public static boolean hasExcellentShop = false;
    ...
    /* The server is in 1.12 or + ? */
    public static boolean is1v12Plus() { return is1v12() || is1v13() || is1v14Plus(); }
    ...
    /* The server is in 1.14 or + ? */
    public static boolean is1v14Plus() {
        return is1v14() || is1v15() || is1v16Plus();
    }
    ...
    public static void loadDependency() {
        ...
        hasExcellentShop = Dependency.EXCELLENT_SHOP.hookSoftDependency();
